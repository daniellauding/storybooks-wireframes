...
export default function FlowPage() {
  ...
  const navigation = [
    ...
    ...(client ? [{ id: 'client', label: client.name, href: `/${clientId}` }] : []),
    ...(project ? [{ id: 'project', label: project.name, href: `/${clientId}/${projectId}` }] : []),
    { id: 'flow', label: flow.name, href: `/${clientId}/${projectId}/flows/${flowId}` },
  ];
